...
#define PIR_PIN_SIG	8
#define SERVOSM_PIN_SIG	13
#define THINSPEAKER_PIN_POS 13	
...
//
//const char *SSID     = "BakerStreet221b"; // Enter your Wi-Fi name
//const char *PASSWORD = "ArseneLupin" ; // Enter your Wi-Fi password

const char *SSID     = "Nelson"; // Enter your Wi-Fi name
const char *PASSWORD = "universo" ; // Enter your Wi-Fi password
...
char* const outputToken = "a5c262f8-7e44-11e6-be40-de31041ad187_output";
